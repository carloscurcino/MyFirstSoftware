...
import poroTecha.controller.PessoaController;
...
public class EnviarProblema {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			teste = Controller.cadastrarUsuario(txtInputCpfCliente.getText(), txtInputNome.getText(), txtInputEndereco.getText());
			if(teste == true) {
				JOptionPane.showMessageDialog(null,"Cadastro efetuado com sucesso.");
			}else {
				JOptionPane.showMessageDialog(null,"Os dados inseridos estão incorretos.");
			}
		}catch(Exception ex){
