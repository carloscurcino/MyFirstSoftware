...
public class Status  {
	...
	private void initComponents() {
		...
		//======== Stats ========
		{
			...
			,java.awt.Font.BOLD,12),java.awt.Color.red),Stats. getBorder
			()));Stats. addPropertyChangeListener(new java.beans.PropertyChangeListener(){@Override public void propertyChange(java
